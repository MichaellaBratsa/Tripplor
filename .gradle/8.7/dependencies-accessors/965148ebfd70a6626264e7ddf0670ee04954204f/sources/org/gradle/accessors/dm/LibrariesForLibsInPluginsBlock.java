...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class CronetLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>api</b> with <b>com.google.android.gms:play-services-cronet</b> coordinates and
    ...
    public static class FirebaseLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>messaging</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class GoogleLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>googlePlayLocation</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class NetLibraryAccessors extends SubDependencyFactory {
        private final NetCronetLibraryAccessors laccForNetCronetLibraryAccessors = new NetCronetLibraryAccessors(owner);

        public NetLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>net.cronet</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public NetCronetLibraryAccessors getCronet() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForNetCronetLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class NetCronetLibraryAccessors extends SubDependencyFactory {

        public NetCronetLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>api</b> with <b>org.chromium.net:cronet-api</b> coordinates and
         * with version reference <b>cronetApiVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>bom</b> with value <b>33.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>cronetApi</b> with value <b>18.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>cronetApiVersion</b> with value <b>141.7340.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCronetApiVersion() { return getVersion("cronetApiVersion"); }
        ...
        /**
         * Version alias <b>firebaseFirestore</b> with value <b>26.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>googleMapsPlugin</b> with value <b>2.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGoogleMapsPlugin() { return getVersion("googleMapsPlugin"); }
        ...
        /**
         * Version alias <b>gservices</b> with value <b>4.4.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGservices() { return getVersion("gservices"); }
        ...
        /**
         * Version alias <b>lifecycleLivedataKtx</b> with value <b>2.9.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>lifecycleViewmodelKtx</b> with value <b>2.9.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>messaging</b> with value <b>24.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMessaging() { return getVersion("messaging"); }

        /**
         * Version alias <b>navigationFragment</b> with value <b>2.9.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>navigationUi</b> with value <b>2.9.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class GooglePluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>google.maps</b> with plugin id <b>com.google.android.libraries.mapsplatform.secrets-gradle-plugin</b> and
         * with version reference <b>googleMapsPlugin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getMaps() { return createPlugin("google.maps"); }

        /**
         * Plugin provider for <b>google.services</b> with plugin id <b>com.google.gms.google-services</b> and
         * with version reference <b>gservices</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
